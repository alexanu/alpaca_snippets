# Source: https://github.com/alpacahq/Momentum-Trading-Example

# Description:
    # If a stock has gained 4% from the previous day's close, +
    # If is above the highest point seen during the first 15 minutes of trading, +
    # If its MACD is positive and increasing. =>
    #
    # algo buys a stock during a 45 minute period each day, starting 15 minutes after market open. 
    # 
    # If there are open positions in your account at the end of the day on a symbol the script is watching, 
    # those positions will be liquidated at market. 
