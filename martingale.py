# Source: https://github.com/alpacahq/alpaca-trade-api-python/blob/master/examples/martingale.py
...
class MartingaleTrader(object):
    def __init__(self):
        ...
        self.base_bet = 10         # % of our buying power that we will allocate to a new position after a streak reset
        ...
        self.current_order = None # When this variable is not None, we have an order open
        self.last_price = 0  # The closing price of the last aggregate we saw

        self.api.cancel_all_orders() # Cancel any open orders so they don't interfere with this script
