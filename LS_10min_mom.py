...
# Description:
    '''
    Every minute rank a given universe of stocks based on %-change in stock price over the past 10 minutes, 
    long the top ranked stocks and short the lower ranked stocks
    '''
import time
import datetime
import pandas as pd
...
class LongShort:
  ...
  def rebalance(self):
    ...
    # ... use leftover equity from the stocks that could not be shorted and shorts the stocks have already been shorted.
    respSendBOShort = []
  ...
  def rerank(self):
    ...
    # grab the top and bottom 25% of stocks
    ...
    # 130% of equity used for longs, 30% of equity used for shorts
    ...
    # Equal quantities across a bucket of stocks
